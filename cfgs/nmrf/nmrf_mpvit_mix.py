...
model = LazyCall(NMRF)(
    backbone=LazyCall(create_backbone)(model_type='mpvit', norm_fn='instance', out_channels=128, drop_path=0.4),
...
runtime_params.pretrained_model = os.path.join(project_root_dir, 'output/SceneFlowDataset/NMRF/mpvit/ckpt/epoch_67/pytorch_model.bin')
