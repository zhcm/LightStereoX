...
train_loader = LazyCall(build_dataloader)(
    is_dist=None,
    all_dataset=[data.weather_train],
...
runtime_params.save_root_dir = os.path.join(project_root_dir, 'output/CarlaWeatherDataset/NMRF')
runtime_params.train_epochs = math.ceil(500000/57890)
