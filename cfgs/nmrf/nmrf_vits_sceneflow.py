...
train_augmentations = [
    ...
    LazyCall(stereo_trans.RandomCrop)(crop_size=[392, 728]),
...
model = LazyCall(NMRF)(backbone=LazyCall(create_backbone)(model_type='hybrid', norm_fn='instance', out_channels=128, drop_path=0.4),
