...
train_augmentations = [
    ...
    LazyCall(stereo_trans.RandomCrop)(crop_size=[352, 768]),
...
# runtime params max_iter=500000, all_batchsize=1, epoch=500000/19134, lr=0.0005
runtime_params.save_root_dir = os.path.join(project_root_dir, 'output/VirtualKitti2Dataset/NMRF')
runtime_params.train_epochs = math.ceil(500000/19134)
