...
data = LazyConfig.load('cfgs/common/datasets/sintel.py')
...
runtime_params.save_root_dir = os.path.join(project_root_dir, 'output/SintelDataset/NMRF')
runtime_params.train_epochs = math.ceil(500000/957)
