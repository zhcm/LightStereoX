...
data = LazyConfig.load('cfgs/common/datasets/dynamic.py')
...
runtime_params.save_root_dir = os.path.join(project_root_dir, 'output/DynamicReplicaDataset/NMRF')
runtime_params.train_epochs = math.ceil(500000/144900)
