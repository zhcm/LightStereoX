...
data = LazyConfig.load('cfgs/common/datasets/foundationstereo.py')
data.train.augmentations = train_augmentations
data.train.return_super_pixel_label = True
...
runtime_params.save_root_dir = os.path.join(ckpt_root_dir, 'output/FoundationStereoDataset/NMRF')
