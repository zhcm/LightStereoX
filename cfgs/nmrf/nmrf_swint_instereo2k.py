...
data = LazyConfig.load('cfgs/common/datasets/instereo2k.py')
...
runtime_params.save_root_dir = os.path.join(project_root_dir, 'output/InStereo2KDataset/NMRF')
runtime_params.train_epochs = math.ceil(500000/2010)
