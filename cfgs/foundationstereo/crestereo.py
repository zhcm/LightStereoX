...
# runtime params
runtime_params.save_root_dir = os.path.join(ckpt_root_dir, 'output/CREStereoDataset/FoundationStereo')
runtime_params.train_epochs = 1
runtime_params.mixed_precision = True
runtime_params.find_unused_parameters = True
runtime_params.pretrained_model = os.path.join(ckpt_root_dir, 'output/SceneFlowDataset/FoundationStereo/node2/ckpt/epoch_90/pytorch_model.bin')
