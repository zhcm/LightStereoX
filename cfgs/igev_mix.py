...
from stereo.modeling.models.igev.igev_stereo import IGEVStereo
...
# train params
runtime_params.save_root_dir = os.path.join(project_root_dir, 'output/MixDataset/IGEV')
runtime_params.train_epochs = 1
runtime_params.eval_period = 100
runtime_params.pretrained_model = 'IGEV_Sceneflow_Amp.pt'
