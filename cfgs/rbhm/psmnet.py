...
# model
model = LazyCall(PSMNet)(max_disp=192)
...
# runtime params
runtime_params.save_root_dir = os.path.join(ckpt_root_dir, 'output/SpeedBumpDataset/Psmnet')
runtime_params.train_epochs = 60
runtime_params.mixed_precision = False
runtime_params.find_unused_parameters = True
runtime_params.pretrained_model = os.path.join(project_root_dir, 'ckpt/psmnet_sceneflow.pt')
