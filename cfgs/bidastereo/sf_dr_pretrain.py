...
augmentations = {
    'train': [
        ...
        LazyCall(stereo_trans.RandomScale)(crop_size=[256, 256], min_pow_scale=-0.2, max_pow_scale=0.4, scale_prob=1.0, stretch_prob=0.8),
        LazyCall(stereo_trans.RandomCrop)(crop_size=[256, 256], y_jitter=True),
