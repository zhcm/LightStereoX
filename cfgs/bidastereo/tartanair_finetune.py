...
tartanair = LazyConfig.load('cfgs/common/sequence_datasets/tartanair.py')
tartanair.train.augmentations = augmentations['train']
tartanair.train.sample_len = 5
