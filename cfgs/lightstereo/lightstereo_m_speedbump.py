...
from stereo.modeling.models.speednump.lightstereo import LightStereo
...
# runtime params
runtime_params.save_root_dir = os.path.join(project_root_dir, 'output/SpeedBump/LightStereo_M')
