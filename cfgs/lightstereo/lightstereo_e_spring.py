...
augmentations = [
    ...
    # LazyCall(stereo_trans.RandomScale)(crop_size=[320, 736], min_scale=0.8, max_scale=1.5, scale_prob=0.7, stretch_prob=0.0),
...
# train params
runtime_params.save_root_dir = os.path.join(project_root_dir, 'output/SpringDataset/LightStereo_E')
