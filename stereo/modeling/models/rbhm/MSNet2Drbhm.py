...
from stereo.modeling.models.msnet.submodule import feature_extraction, MobileV2_Residual, convbn, interweave_tensors, disparity_regression
...
class MSNet2D(nn.Module):
    ...
    def forward(self, data):
        ...
        if self.training:
            ...
            pred_height = self.height_head(torch.cat([data["left"], pred3.unsqueeze(1)], dim=1))
