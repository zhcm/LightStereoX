...
from .cost_volume import build_sub_volume, InterlacedVolume, build_concat_volume, build_gwc_volume
...
class StereoBase(nn.Module):
    def __init__(self, max_disp=192, num_groups=8, concat_channels=8, use_concat_volume=True, use_gwc_volume=True, use_sub_volume=False, use_interlaced_volume=False,
                 interlaced_feature_channel=8,
                 hidden_dims=[128, 128, 128], n_downsample=2, n_gru_layers=3, corr_radius=4, corr_levels=2, slow_fast_gru=False):
        super().__init__()
        self.max_disp = max_disp
        self.num_groups = num_groups
        self.use_concat_volume = use_concat_volume
        self.use_gwc_volume = use_gwc_volume
        self.use_sub_volume = use_sub_volume
        self.use_interlaced_volume = use_interlaced_volume
        self.concat_feature_channel = concat_channels
        self.interlaced_feature_channel = interlaced_feature_channel
    ...
    def forward(self, data):
        ...
        iters = 22 if self.training else 32
