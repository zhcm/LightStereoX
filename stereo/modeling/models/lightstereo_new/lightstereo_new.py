...
class LightStereo(nn.Module):
    ...
    def forward(self, data):
        ...
        match_left, features_left = self.backbone(image1)
        match_right, features_right = self.backbone(image2)

        volume = build_sub_volume(match_left, match_right, self.max_disp // 4)
        ...
        xspx = self.refine_3(features_left[0])
