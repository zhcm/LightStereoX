...
class ChannelAtt(nn.Module):
    def __init__(self, cv_chan, im_chan, v):
        ...
        #     BasicConv2d(im_chan, cv_chan, kernel_size=1, norm_layer=nn.BatchNorm2d,act_layer=nn.ReLU),
        #     BasicConv2d(cv_chan, cv_chan, kernel_size=1, norm_layer=nn.BatchNorm2d),
        # )
        #
    ...
    def forward(self, cost, im):
        ...
        # channel_term = cost_feat + im_feat.unsqueeze(2)
